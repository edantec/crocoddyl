...
void exposeCostControlGravContact() {
  bp::class_<CostModelControlGravContact, bp::bases<CostModelAbstract> >(
   ...
   bp::class_<CostDataControlGravContact, bp::bases<CostDataAbstract> >(
      ...
      .add_property("rnea_partial_dx", bp::make_getter(&CostDataControlGravContact::rnea_partial_dx, bp::return_internal_reference<>()),
                    "Partial derivative of rnea in contact with respect to x")
      .add_property("rnea_partial_da", bp::make_getter(&CostDataControlGravContact::rnea_partial_da, bp::return_internal_reference<>()),
